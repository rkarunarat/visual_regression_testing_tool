"""History page — browse, load, export, and delete saved test runs."""
import logging
import shutil
...
def history_page():
    """List saved runs and load results into the Results page."""
    render_page_header(
        "History",
    ...
    if not test_runs:
        st.info("No saved test runs yet. Complete a run on **New Test** to see it here.")
        return
